...
model = dict(
    ...
    criteria = [
    dict(type="BoundaryWeightedCrossEntropyLoss", alpha=3.0, k=16, loss_weight=2.0, ignore_index=-1),
    dict(type="CrossEntropyLoss", loss_weight=2.0, weight=[1.0, 10.0, 2.0], ignore_index=-1),
...
# ---------------------------------------------------------------------------- #
epoch = 400 # standard training epoch is 200
